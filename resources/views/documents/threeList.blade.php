...
@section('content')
	...
	<br>
	<p class="text-center" id="text-header">LISTA No "UNO" (BIS).</p>
	...
	<p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LISTA No "UNO" (BIS) QUE SE ELABORA COMO RESULTADO DEL SORTEO DEL PERSONAL DEL S.M.N CLASE "<u>{{ $response->list->class }}</u>", ANTICIPADOS Y REMISOS, QUE RESULTARON AGRACIADOS CON <b>BOLA AZUL</b> REALIZADO EN ESTA JUNTA DE RECLUTAMIENTO CONFORME A LOS LINEAMIENTOS ESTABLECIDOS EN LA LEGISLACIÓN VIGENTE.</p>
