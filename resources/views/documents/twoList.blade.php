...
@section('content')
	...
	<br>
	<p class="text-center" id="text-header">LISTA No "DOS".</p>
	...
	<p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LISTA No "DOS" QUE SE ELABORA COMO RESULTADO DEL SORTEO DEL PERSONAL DEL S.M.N CLASE "<u>{{ $response->list->class }}</u>", ANTICIPADOS Y REMISOS, QUE RESULTARON AGRACIADOS CON <b>BOLA NEGRA</b> REALIZADO EN ESTA JUNTA DE RECLUTAMIENTO CONFORME A LOS LINEAMIENTOS ESTABLECIDOS EN LA LEGISLACIÓN VIGENTE.</p>
