...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<h4><i class="fa fa-edit"></i> Capturar datos para listas de sorteo</h4>
		...
		<form action="{{ route('storeInitialList') }}" method="post">
			{{ csrf_field() }}
			<input type="hidden" name="list_id" value="{{ $response->list->id or '' }}">
			<div class="col-md-8">
				<div class="row">
					<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group {{ $errors->has('class') ? ' has-error' : '' }}">
											...
											<input type="text" name="class" id="class" class="form-control" value="{{ $response->list->class or old('class') }}" placeholder="Clase">
											@if($errors->has('class'))
										...
										<div class="form-group {{ $errors->has('local_board') ? ' has-error' : '' }}">
											...
											<input type="text" name="local_board" id="local_board" class="form-control" value="{{ $response->list->local_board or old('local_board') }}" placeholder="Junta municipal de reclutamiento">
										...
										<div class="form-group {{ $errors->has('board_place') ? ' has-error' : '' }}">
											...
											<input type="text" name="board_place" id="board_place" class="form-control" value="{{ $response->list->board_place or old('board_place') }}" placeholder="Municipio de la junta de reclutamiento">
									...
									<div class="col-md-6">
										<div class="form-group {{ $errors->has('president') ? ' has-error' : '' }}">
											...
											<input type="text" name="president" id="president" class="form-control" value="{{ $response->list->president or old('president') }}" placeholder="Nombre completo del presidente">
										...
										<div class="form-group {{ $errors->has('date_place') ? ' has-error' : '' }}">
											...
											<input type="text" name="date_place" id="date_place" class="form-control" value="{{ $response->list->date_place or old('date_place') }}" placeholder="Lugar y fecha con letra">
			...
			<div class="col-md-4">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<a href="{{ route('listInitialLists') }}" class="btn btn-default btn-block"><i class="fa fa-arrow-left"></i> Regresar</a>
					</div>
				</div>
			</div>
		</form>
